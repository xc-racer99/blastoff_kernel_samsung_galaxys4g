 ...
 */
static int __init stlc2690_chip_probe(struct platform_device *pdev)
{
	int err = 0;
 ...
 */
static int __exit stlc2690_chip_remove(struct platform_device *pdev)
{
...
static struct platform_driver stlc2690_chip_driver = {
	...
	.remove	= __exit_p(stlc2690_chip_remove),
};
